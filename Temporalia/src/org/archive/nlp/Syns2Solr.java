...
public class Syns2Solr
{
	...
	private static PrintStream oSyn;
...
//    private static final Analyzer ana = new StandardAnalyzer(Version.LUCENE_CURRENT);
    ...
    {
    	String prologF = "H:/v-haiyu/TaskPreparation/Temporalia/lucene/syn/wn_s.pl";
    	String indexD = "H:/v-haiyu/TaskPreparation/Temporalia/lucene/syn/output";
    	
    	oSyn = new PrintStream(new FileOutputStream(new File("H:/v-haiyu/TaskPreparation/Temporalia/lucene/syn/"+"syn.txt")));
